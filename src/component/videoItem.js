    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Text  numberOfLines={1} style={styles.videoStats}>{video.snippet.channelTitle + " · " +  nFormatter(video.statistics.viewCount)+ ' · 3 months ago'}</Text>

                    </View>
                    <TouchableOpacity>
                        <Icon name="more-vert" size={25} color="#900"/>
                    </TouchableOpacity>
                </View>
